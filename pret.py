...
def intro(quiet):
  if not quiet:
    ...
    print("   /___________/___//||   PRET | Взлом принтера в локальной сети  v0.40                ")
    print("  |===        |----| ||    Автор основного кода - Jens Mueller <jens.a.mueller@rub.de> ")
    print("  |           |   ô| ||     перевел и озвучил - batyarimskiy                           ")
    print("  |___________|   ô| ||                                                                ")                                                       
    print("  | ||/.´---.||    | ||      「 Исключительно в ознакомительных целях                  ")
    print("  |-||/_____\||-.  | |´        только пентест‥ 」                                      ")                                                       
    print("  |_||=L==H==||_|__|/                                                                  ")
    print("                                                                                       ")
    print("                                                                                       ")
    print("                                                                                       ")
